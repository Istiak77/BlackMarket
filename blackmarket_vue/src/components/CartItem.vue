<template>
  <tr>
    ...
    <td>
      {{ item.quantity }}
      <button class="button is-small is-rounded is-danger mx-1" @click="decrementQuantity(item)">-</button>
      <button class="button is-small is-rounded is-success mx-1" @click="incrementQuantity(item)">+</button>
    </td>
